...
```{r combi3, out.width="50%", fig.show='hold', fig.cap="The location of schools, residential areas, and heavily used routes to schools in the Leeds and Bradford area. (i)(left) Showing routes which are estimated to carry at least 100 journeys to school under the dutch_slc scenario. Schools are in black, with LSOA centroids in yellow, and built-up areas in grey as derived from ONS data. (ii)(right) Schools in purple, with residential areas defined as areas within 500m of an LSOA centroid, masked to the ONS-defined built-up area. Routes are clipped within these residential areas."}
