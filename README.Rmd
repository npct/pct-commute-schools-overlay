...
```{r combi6}
purposes = data.frame(Purpose = c("Commuting","Business",""))
sec_schools
```

Other factors that could be worth investigating further include road safety and how the locations of accident blackspots match up with heavily cycled routes. It would also be interesting to look at which schools currently have the highest levels of cycling and whether those schools share certain characteristics.
...
Further investigation is required into the overall distribution of journey purposes. 